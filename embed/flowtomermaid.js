...
%%
`),(c.wirecfgs||[]).forEach(a=>{var t=a.name.split(";").map(e=>e.trim()),r=(i[("self"==a.id?c:a).id].name||"unknown_state").toLowerCase().replaceAll(/[\s\t\n ]/g,"_");if(1==t.length&&""==t[0])o.push(`
%
